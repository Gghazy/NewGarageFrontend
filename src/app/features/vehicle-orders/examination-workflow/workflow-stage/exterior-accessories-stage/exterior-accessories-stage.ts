...
interface AccessoryStageResultDto {
...
export class ExteriorAccessoriesStageComponent extends BaseStageComponent implements OnInit, OnDestroy {
  ...
  save(): void {
    ...
    this.api.post<ApiResponse<string>>(`Examinations/${examId}/stages/accessories`, payload)
      .pipe(
  ...
  private loadData(): void {
    ...
    forkJoin({
      ...
      switchMap(() => {
        ...
        return this.api.get<ApiResponse<AccessoryStageResultDto>>(`Examinations/${examId}/stages/accessories`);
      }),
  ...
  private applyExistingData(data: AccessoryStageResultDto | null): void {
    if (!data) return;
